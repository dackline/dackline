...
<div class="row">
    <div class="col-12">
        <div class="tw-mb-8">
            <a href="{{ route('zones.create') }}" class="btn btn-primary waves-effect waves-float waves-light">
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('zones.edit', ['zone' => $zone->id]) }}" class="btn btn-sm btn-icon btn-outline-secondary waves-effect">
