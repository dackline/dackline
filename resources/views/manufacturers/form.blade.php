...
<section>
    <form id="module-form" class="form form-horizontal" method="POST" action="{{ isset($manufacturer->id) ? route('manufacturers.update', $manufacturer->id) : route('manufacturers.store') }}" x-data="moduleData()" x-init="moduleInit()" x-on:submit="submit()" novalidate>
        @csrf
