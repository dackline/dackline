    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form id="module-form" class="form form-horizontal" method="POST" action="{{ isset($country->id) ? route('admin::countries.update', $country->id) : route('admin::countries.store') }}" novalidate>
                        @csrf
                        @if(isset($country->id))
                            @method('PUT')
                        @endif
