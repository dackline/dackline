<span class="tw-flex">
    <a href="{{ route('admin::products.edit', $row->id) }}" class="btn btn-sm btn-icon btn-outline-secondary waves-effect">
    ...
    <button type="button" class="btn btn-sm btn-icon btn-outline-danger waves-effect tw-ml-1" wire:click="deleteProduct({{ $row->id }})" onclick="confirm('{{ __('Are you sure to delete?') }}') || event.stopImmediatePropagation()">
