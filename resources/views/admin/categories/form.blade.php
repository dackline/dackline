...
<section>
    <form id="module-form" class="form form-horizontal" method="POST" action="{{ isset($category->id) ? route('admin::categories.update', $category->id) : route('admin::categories.store') }}" x-data="moduleData()" x-init="moduleInit()" x-on:submit="submit()" novalidate>
        @csrf
