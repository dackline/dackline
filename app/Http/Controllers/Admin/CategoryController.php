...
class CategoryController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.categories.list', compact('categories', 'breadcrumbs'));
    }
    ...
    public function create()
    {
        ...
        $breadcrumbs = [
            ['link' => route('admin::categories.index'), 'name' => "Categories"], ['name' => "Create"]
        ];

        return view('admin.categories.form', compact('category', 'breadcrumbs', 'stores', 'categories'));
    }
    ...
    public function edit(Category $category)
    {
        ...
        $breadcrumbs = [
            ['link' => route('admin::categories.index'), 'name' => "Categories"], ['name' => "Edit"]
        ];
