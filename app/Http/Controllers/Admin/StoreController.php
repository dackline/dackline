...
class StoreController extends Controller
{
    ...
    public function index()
    {
        ...
        $breadcrumbs = [
            ['link' => route('admin::dashboard'), 'name' => "Dashboard"], ['name' => "Stores"]
        ];

        return view('admin.stores.list', compact('stores', 'breadcrumbs'));
    }
    ...
    public function create()
    {
        ...
        $breadcrumbs = [
            ['link' => route('admin::stores.index'), 'name' => "Stores"], ['name' => "Create"]
        ];

        return view('admin.stores.form', compact('store', 'breadcrumbs', 'countries', 'currencies', 'taxes'));
    }
    ...
    public function store(StoreStoreRequest $request)
    {
        ...
        return redirect(route('admin::stores.index'))->with('success', __('Store Created.'));
    }
    ...
    public function edit(Store $store)
    {
        ...
        $breadcrumbs = [
            ['link' => route('admin::stores.index'), 'name' => "Stores"], ['name' => "Edit Store"]
        ];
     ...
     *
     * @param  \App\Http\Requests\Admin\UpdateStoreRequest  $request
     * @param  \App\Models\Store  $store
     * @return \Illuminate\Http\Response
     */
    public function update(UpdateStoreRequest $request, Store $store)
    {
        ...
        return redirect(route('admin::stores.index'))->with('success', __('Store Updated.'));
    }
