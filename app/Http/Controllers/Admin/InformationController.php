...
class InformationController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.informations.list', compact('informations', 'breadcrumbs'));
    }
    ...
    public function create()
    {
        ...
        $breadcrumbs = [
            ['link' => route('admin::informations.index'), 'name' => "Informations"], ['name' => "Create"]
        ];

        return view('admin.informations.form', compact('information', 'breadcrumbs', 'stores'));
    }

    /**
     * Store a newly created resource in storage.
     *
     * @param  \App\Http\Requests\Admin\StoreInformationRequest  $request
     * @return \Illuminate\Http\Response
     */
    public function store(StoreInformationRequest $request)
    {
        ...
        return redirect(route('admin::informations.index'))->with('success', __('Information Created.'));
    }
    ...
    public function edit(Information $information)
    {
        ...
        $breadcrumbs = [
            ['link' => route('admin::informations.index'), 'name' => "Informations"], ['name' => "Edit"]
        ];
     ...
     *
     * @param  \App\Http\Requests\Admin\UpdateInformationRequest  $request
     * @param  \App\Models\Information  $information
     * @return \Illuminate\Http\Response
     */
    public function update(UpdateInformationRequest $request, Information $information)
    {
        ...
        return redirect(route('admin::informations.index'))->with('success', __('Information Updated.'));
    }
