...
class ProductController extends Controller
{
    ...
    public function create()
    {
        ...
        $breadcrumbs = [
            ['link' => route('admin::products.index'), 'name' => "Products"], ['name' => "Create"]
        ];

        return view('admin.products.form', compact('product', 'breadcrumbs', 'taxes', 'stockStatuses', 'manufacturers', 'stores', 'categories', 'options', 'productOptions', 'productImage', 'additionalImages'));
    }
    ...
    public function edit(Product $product)
    {
        ...
        $breadcrumbs = [
            ['link' => route('admin::products.index'), 'name' => "Products"], ['name' => "Edit"]
        ];
