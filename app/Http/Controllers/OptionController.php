...
use App\Models\OptionValueDetail;
...
class OptionController extends Controller
{
    ...
    public function index()
    {
        ...
        $breadcrumbs = [
            ['link' => route('dashboard'), 'name' => "Dashboard"], ['name' => "Options"]
        ];

        return view('options.list', compact('options', 'breadcrumbs'));
    }
    ...
    public function create()
    {
        ...
        $breadcrumbs = [
            ['link' => route('options.index'), 'name' => "Options"], ['name' => "Create"]
        ];

        return view('options.form', compact('option', 'breadcrumbs'));
    }
    ...
    public function store(StoreOptionRequest $request)
    {
        ...
        return redirect(route('options.index'))->with('success', __('Option Created.'));
    }
    ...
    public function edit(Option $option)
    {
        ...
        $breadcrumbs = [
            ['link' => route('options.index'), 'name' => "Options"], ['name' => "Edit"]
        ];
    ...
    public function update(UpdateOptionRequest $request, Option $option)
    {
        ...
        return redirect(route('options.index'))->with('success', __('Option Updated.'));
    }
