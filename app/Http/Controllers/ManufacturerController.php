...
class ManufacturerController extends Controller
{
    ...
    public function index()
    {
        ...
        $breadcrumbs = [
            ['link' => route('dashboard'), 'name' => "Dashboard"], ['name' => "Manufacturers"]
        ];

        return view('manufacturers.list', compact('manufacturers', 'breadcrumbs'));
    }
    ...
    public function create()
    {
        ...
        $breadcrumbs = [
            ['link' => route('manufacturers.index'), 'name' => "Manufacturers"], ['name' => "Create"]
        ];

        return view('manufacturers.form', compact('manufacturer', 'breadcrumbs', 'stores'));
    }
    ...
    public function store(StoreManufacturerRequest $request)
    {
        ...
        return redirect(route('manufacturers.index'))->with('success', __('Manufacturer Created.'));
    }
    ...
    public function edit(Manufacturer $manufacturer)
    {
        ...
        $breadcrumbs = [
            ['link' => route('manufacturers.index'), 'name' => "Manufacturers"], ['name' => "Edit"]
        ];
    ...
    public function update(UpdateManufacturerRequest $request, Manufacturer $manufacturer)
    {
        ...
        return redirect(route('manufacturers.index'))->with('success', __('Manufacturer Updated.'));
    }
